...
### Fixed
- **Inventory row hover works again** — dark mode no longer suppresses the hover's teal edge, and the light-mode zebra stripe no longer uses the exact hover colour (which made hovering odd rows invisible).
