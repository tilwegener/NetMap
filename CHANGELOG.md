...
- **Managed custom device types** — Admin → System → Icons can add reusable custom device types, assign a default Tabler icon, and remove unused custom types. Device forms, Inventory bulk actions, Topology, and Overview all consume the same managed type list. Migration `0042_device_types`.
